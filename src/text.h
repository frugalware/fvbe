...
#define PROFILE_NAME_TEXT _("Profile Name")
#define ADDRESS_TEXT _("Address")
#define PREFIX_TEXT _("Prefix")
#define GATEWAY_TEXT _("Gateway")
#define DNS_SERVERS_TEXT _("DNS Servers")
#define SEARCH_DOMAINS_TEXT _("Search Domains")
#define SSID_TEXT _("SSID")
#define PSK_TEXT _("PSK")
#define USER_ERROR_TITLE _("Invalid User Data")
#define USER_ERROR_TEXT _("You have specified invalid user data.\nIt must meet the following criteria:\n\nPasswords must be non-empty and match.\nUser name must match this pattern: '^[a-z_][a-z0-9_-]*[$]?$'\n")
...
#define NM_ASK_IP_TITLE _("%s Setup")
#define NM_ASK_IP_TEXT _("Do you wish to configure %s for this profile?\n")
...
#define NM_ACTIVE_TEXT _("Select a profile to activate from the list below.\n")
...
#define NM_CHANGE_TITLE _("Change Network Profiles")
#define NM_CHANGE_TEXT _("Do you wish to change network profiles?\n")
...
#define NO_GRUB_TITLE _("Cannot Embed GRUB")
...
#define NO_GRUB_UEFI_TEXT _("At least one of your partition tables must have an EFI partition.\nThis partition must be at least 1 MiB in size.\nIt is for these reasons that you cannot embed GRUB.\nDo you wish to proceed anyway?\n")
...
#define DM_TITLE _("Display Manager Setup")
#define DM_TEXT _("Select a display manager from the list below.\nSelect 'none' if you wish to disable the display manager.\n")
