...
#define NO_RAID_DISKS_TEXT _("You have not selected enough RAID devices for your chosen RAID level.\nLevels 0 and 1 require a minimum of 2 devices.\nLevels 4 and 5 require a minimum of 3 devices.\nLevels 6 and 10 require a minimum of 4 devices.\n")
...
#define HOST_TITLE _("Machine Name Setup")
#define HOST_TEXT _("Enter the hostname and the pretty hostname for this machine.\nThe hostname is used by machines.\nThe pretty hostname is used by people.\n")
